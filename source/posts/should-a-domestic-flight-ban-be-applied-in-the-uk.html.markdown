...
Domestic flight routes between London and Leeds (310km), Newcastle (450km), Manchester (305km), Glasgow (660km) and Edinburgh (650km) [account for over 14 million passengers annually](https://www.caa.co.uk/Data-and-analysis/UK-aviation-market/Airports/Datasets/UK-Airport-data/Airport-data-2018/). Of these, only Leeds and Manchester are within the 2.5 hour time window, therefore it makes sense for a UK policy to include all routes up to 700km. The potential for carbon savings is huge: a return trip from London to Edinburgh by train produces 43.76kg carbon dioxide equivalent (CO2e) per passenger as opposed to 275.87kg CO2e by plane – a saving of 232kg CO2e*.

Suggested policy: ‘All journeys that can be completed by train in 4.5 hours, approximately 700 km, should not have an aviation competitor in 2025.’ This policy would reduce our domestic aviation emissions by [an estimated 35%](https://www.caa.co.uk/Data-and-analysis/UK-aviation-market/Airports/Datasets/UK-Airport-data/Airport-data-2018/) or about 1.5% of our total aviation emissions.

#### Apply the policy to international travel

70–80% of flights from the UK [are within Europe](https://www.gov.uk/government/statistical-data-sets/aviation-statistics-data-tables-avi) and over [50% are to our nearest neighbours](https://www.gov.uk/government/statistical-data-sets/aviation-statistics-data-tables-avi). These countries are mostly less than 1500km away: within one day’s travel by train and car.
...
Emissions reductions internationally have the potential to be greater than our domestic reductions, as Eurostar emissions are up to [15 times lower](https://www.eurostar-treadlightly.com/en/environment.php) than the equivalent flight, as opposed to just [six times lower](https://www.gov.uk/government/publications/greenhouse-gas-reporting-conversion-factors-2019) for National Rail.

#### Push for a global 700km policy

Applying a 550km policy globally would remove about [5% of passenger emissions](https://theicct.org/sites/default/files/publications/ICCT_CO2-commercl-aviation-2018_20190918.pdf). If a 700km rule were applied, the reduction would be closer to 10–15% of global aviation emissions. In Europe this would include some of the [busiest routes](https://www.oag.com/reports/busiest-routes-2020) (Barcelona-Madrid; Frankfurt to Berlin; Paris to Toulouse, Munich to Berlin) – [routes of less than 150 km](https://www.oag.com/reports/busiest-routes-2020), which are easily served by train.
...
* Treat flying as a special occasion, a once or twice a year activity at most. In the UK, [15% of people take 70% of the flights](https://fullfact.org/economy/do-15-people-take-70-flights/). This means that frequent flyers are responsible for about 5% of UK’s total emissions\*\**. If you are one of these frequent flyers you can make meaningful reductions.
